...
import { HelpCircle, Clock, User, AlertTriangle, ShieldCheck } from 'lucide-react';
...
export default function SupportConsole({ tickets, onResolveTicket }: SupportConsoleProps) {
  ...
  return (
    <div id="support-console-root" className="space-y-6 font-sans">
      ...
      {filteredTickets.length === 0 ? (
        <div className="bg-white dark:bg-zinc-900 p-12 text-center rounded-2xl border border-gray-100 dark:border-zinc-800/60 flex flex-col justify-center items-center">
        ...
        <div className="grid grid-cols-1 gap-4">
          {filteredTickets.map(t => (
            <div key={t.id} className="bg-white dark:bg-zinc-900 border border-gray-100 dark:border-zinc-800/60 p-5 rounded-2xl shadow-sm space-y-4">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pt-4 border-t border-gray-50 dark:border-zinc-800/10 font-sans">
