...
import { Sparkles, Wallet, Plus, Trash2, Instagram, Youtube, Send, Phone, Globe, ExternalLink } from 'lucide-react';
...
export default function SugoraTree({ currentUser, availableProducts }: SugoraTreeProps) {
  ...
  const themeStyles = {
    modern: 'bg-zinc-50 text-zinc-900 border-none',
    dark_neon: 'bg-zinc-950 text-white border-zinc-800',
    pastel: 'bg-rose-50 text-rose-900 border-none',
  ...
  const phoneCardStyles = {
    ...
    pastel: 'bg-white text-rose-900 hover:bg-rose-100 border border-rose-100/40',
  ...
  return (
    <div id="sugora-tree-root" className="grid grid-cols-1 lg:grid-cols-12 gap-8 font-sans">
      ...
      <div className="lg:col-span-12 xl:col-span-7 space-y-6">
        <div className="bg-white dark:bg-zinc-900 rounded-2xl border border-gray-100 dark:border-zinc-800 p-5 shadow-sm">
          ...
          <p className="text-xs text-gray-500 mt-1">
            ...
            <span className="font-mono text-emerald-600 block mt-1 bg-emerald-50 dark:bg-emerald-950/20 px-2 py-1 rounded w-fit text-[11px] dark:text-emerald-300">
      ...
      <div className="lg:col-span-12 xl:col-span-5 flex flex-col items-center">
        ...
        <div className="w-full max-w-[285px] h-[550px] bg-zinc-900 rounded-[38px] p-3.5 shadow-2xl relative border-[4px] border-zinc-800 ring-6 ring-zinc-950/20">
          ...
          <div className="absolute top-0 inset-x-0 flex justify-center z-10 w-full">
            <div className="h-4.5 w-28 bg-zinc-900 rounded-b-xl flex items-center justify-around px-2 text-[8px] text-white/40 mx-auto">
          ...
          >
            ...
            <div className="space-y-2 flex-grow mt-2">
              {treeProfile.links.map(l => (
                ...
                >
                  <span className="truncate flex-grow text-center">{l.title}</span>
