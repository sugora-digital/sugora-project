  ...
  return (
    <div id="ai-chat-root" className="grid grid-cols-1 lg:grid-cols-12 h-full w-full rounded-none md:rounded-2xl overflow-hidden border border-slate-100 dark:border-zinc-850 bg-white dark:bg-[#0c0d12] shadow-xs md:shadow-lg flex-1">
      ...
      <div className={`${isSidebarOpen ? 'flex' : 'hidden'} lg:flex lg:col-span-4 shrink-0 border-r border-slate-100 bg-slate-50/50 flex-col justify-between`}>
        ...
        <div className="p-4 space-y-4 border-b border-slate-100 bg-white border-0">
          ...
          <div className="space-y-1">
            <div className="flex items-center justify-between text-[9px] text-slate-400 font-bold uppercase tracking-widest px-1">
              ...
              <button onClick={() => setIsCreatingFolder(!isCreatingFolder)} className="hover:text-blue-600 border-0 bg-transparent cursor-pointer">
            ...
            {isCreatingFolder && (
              <div className="flex gap-1.5 mt-2 p-1.5 border border-dashed border-slate-200 rounded-xl bg-slate-50">
                ...
                />
                <button onClick={handleCreateFolder} className="bg-blue-600 text-white rounded px-2.5 py-1 text-[9px] font-bold border-0 cursor-pointer">
                  Add
                </button>
              </div>
            )}
                ...
                >
                  <div className="flex items-center justify-between min-w-0">
                    ...
                    <button
                      ...
                      className="p-1 rounded opacity-0 group-hover:opacity-100 hover:bg-red-50 hover:text-red-600 transition shrink-0 border-0 bg-transparent cursor-pointer"
                    >
        ...
        <div className="p-4 border-t border-slate-100 bg-white">
          <div className="rounded-2xl bg-gradient-to-r from-blue-50/50 to-indigo-50/50 p-3.5 border border-slate-100">
            ...
            <p className="text-[9.5px] text-slate-500 mt-2 font-semibold leading-relaxed">
      ...
      <div className="lg:col-span-8 flex flex-col justify-between bg-white relative">
        ...
        <div className="px-4 py-3.5 border-b border-slate-100 flex items-center justify-between bg-white shadow-xs shrink-0">
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="lg:hidden p-1.5 rounded-lg bg-slate-50 hover:bg-slate-100 text-slate-500 border-0 cursor-pointer"
            >
            ...
            <div className="text-left">
              <h3 className="text-xs font-bold text-slate-900 flex items-center gap-1.5 leading-tight">
                Sugora Copilot
                <span className="inline-flex items-center rounded bg-emerald-50 px-1.5 py-0.5 text-[9px] font-bold text-emerald-700 animate-pulse">
                  Online
                </span>
              </h3>
          ...
          <div className="flex items-center gap-2">
            <button 
              onClick={handleCreateNewChat} 
              className="p-2 rounded-xl hover:bg-slate-50 text-slate-500 border-0 bg-transparent cursor-pointer"
        ...
        <div className="flex-1 overflow-y-auto p-4 md:p-6 bg-slate-50/20 space-y-4">
            ...
            return (
              ...
              >
                <div className={`max-w-[85%] rounded-2xl p-4.5 shadow-xs relative group/bubble border ${
                  ...
                  <div className="flex items-center justify-between gap-4 border-b border-slate-100 pb-2 mb-2">
                    ...
                    <div className="flex items-center gap-1.5">
                      <button
                        ...
                        className="p-1 hover:bg-slate-100 rounded text-slate-400 hover:text-slate-600 transition border-0 bg-transparent cursor-pointer"
                        title="Copy message"
                      >
                          ...
                          <div className="absolute right-0 bottom-full mb-1 z-20 bg-white border border-slate-150 shadow-md rounded-lg p-1.5 flex gap-1 animate-fadeIn">
                            {POPULAR_EMOJIS.map(emoji => (
                              <button
                                ...
                                className="hover:bg-slate-50 p-1 text-sm rounded transition border-0 bg-transparent cursor-pointer"
                              >
                                {emoji}
                              </button>
                            ))}
                  ...
                  <div className="text-xs text-slate-700 leading-relaxed font-sans space-y-3 prose max-w-none text-left">
                  ...
                  <span className="block text-[8px] opacity-40 text-right mt-2 text-slate-400 select-none font-mono">
          ...
          {isPendingAI && (
            <div className="flex justify-start">
              <div className="bg-white border border-slate-100 p-4 rounded-2xl flex items-center gap-2.5 shadow-sm">
        ...
        <div className="p-3 md:p-4 border-t border-slate-150 bg-white shrink-0">
          ...
          {attachedImage && (
            <div className="flex items-center justify-between bg-blue-50 border border-blue-100 rounded-xl px-3.5 py-1.5 mb-3 text-xs text-blue-800 animate-fadeIn text-left">
              <div className="flex items-center gap-2">
                <Image className="h-4 w-4" />
                <span>Simulated Image file ready for review</span>
              </div>
              <button onClick={() => setAttachedImage(null)} className="text-[10px] font-bold text-red-650 border-0 bg-transparent cursor-pointer">
                Cancel
              </button>
            </div>
          )}
          ...
          {isMicListening && (
            <div className="flex items-center gap-2.5 bg-red-50 border border-red-100 rounded-xl px-3.5 py-2 mb-3 text-xs text-red-800 animate-pulse text-left">
          ...
          <div className="flex gap-2 items-center">
            ...
            <div className="flex gap-1">
              <button
                ...
                className="p-2.5 rounded-xl bg-slate-50 hover:bg-slate-100 text-slate-505 transition active:scale-95 border-0 cursor-pointer"
              ...
              <button
                ...
                className={`p-2.5 rounded-xl transition active:scale-95 border-0 cursor-pointer ${
                  isMicListening 
