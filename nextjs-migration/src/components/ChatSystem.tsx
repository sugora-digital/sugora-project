...
import { Search, Send, Image, Paperclip, Smile, MoreVertical, Check, CheckCheck, ArrowLeft, Sparkles, Share2 } from 'lucide-react';
...
export default function ChatSystem({ currentUser }: ChatSystemProps) {
  ...
  return (
    <div id="chat-system-widget" className="relative flex h-[620px] rounded-2xl overflow-hidden border border-gray-100 bg-white shadow-xl dark:border-zinc-800/80 dark:bg-zinc-950 font-sans">
      ...
      <div className={`w-full md:w-80 shrink-0 border-r border-gray-100 dark:border-zinc-800/60 bg-gray-50/50 dark:bg-zinc-900/30 flex flex-col ${
        ...
        <div className="p-4 border-b border-gray-50 dark:border-zinc-800">
          <h2 className="text-lg font-bold text-gray-900 dark:text-zinc-100 flex items-center gap-2">
            Sugora Chat <span className="text-xs bg-emerald-100 text-emerald-800 px-2 py-0.5 rounded-full font-medium dark:bg-emerald-950/45 dark:text-emerald-300">Realtime</span>
          </h2>
          <div className="mt-3 relative">
            ...
            <input
              ...
              className="w-full rounded-xl bg-white dark:bg-zinc-900 py-2 pl-9 pr-4 text-xs border border-gray-100 dark:border-zinc-800 focus:outline-none focus:ring-2 focus:ring-emerald-500 text-gray-900 dark:text-zinc-100"
            />
          </div>
        </div>

        {/* Channels/Inbox Scroll Column */}
        <div className="flex-1 overflow-y-auto divide-y divide-gray-50/40 dark:divide-zinc-800/20">
          {filteredRooms.map((r) => {
            ...
            return (
              <button
                ...
                className={`w-full p-4 flex items-start gap-3 text-left transition ${
                  isSelected ? 'bg-emerald-50/85 dark:bg-emerald-950/20 border-l-4 border-emerald-500' : 'hover:bg-gray-100/50 dark:hover:bg-zinc-900/40'
                }`}
              >
                <div className="relative shrink-0 text-[1px]">
                  <img
                    ...
                    className="h-11 w-11 rounded-full object-cover ring-2 ring-gray-150"
                  />
                  {r.is_online && (
      ...
      <div className={`flex-1 flex flex-col bg-white dark:bg-zinc-950 ${
        isMobileListOpen ? 'hidden md:flex' : 'flex font-sans'
      }`}>
        {activeRoom ? (
          <>
            ...
            <div className="px-4 py-3 border-b border-gray-100 dark:border-zinc-800 flex items-center justify-between bg-white dark:bg-zinc-950 shadow-sm shrink-0">
              ...
              <div className="flex items-center gap-1">
                {activeRoom.type === 'support' && (
                  <span className="inline-flex items-center gap-1 rounded bg-teal-50 px-2 py-0.5 text-[10px] font-semibold text-teal-700 dark:bg-teal-950/30 dark:text-teal-400">
                  ...
                  >
                    <div className={`max-w-[75%] rounded-2xl p-3 shadow-sm ${
                      ...
                      {msg.file_url && msg.file_type === 'image' && (
                        <div className="mt-2 text-center text-[1px]">
                          <img
                            referrerPolicy="no-referrer"
                            src={msg.file_url}
                            alt="attachment"
                      ...
                      {msg.file_url && msg.file_type === 'file' && (
                        <div className={`mt-2 p-2 rounded flex items-center gap-2 text-xs font-mono border ${
                          isMyMessage ? 'bg-emerald-700/50 border-emerald-500' : 'bg-gray-50 dark:bg-zinc-800 border-gray-105'
                        }`}>
            ...
            <div className="p-3 border-t border-gray-100 dark:border-zinc-800 bg-white dark:bg-zinc-950 shrink-0">
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  className="p-1.5 focus:outline-none text-gray-500 hover:text-gray-751 text-xs"
                ...
                <textarea
                  ...
                  className="flex-1 rounded-xl bg-gray-50 dark:bg-zinc-900 border border-gray-100 dark:border-zinc-800 py-2 px-3 text-xs focus:outline-none focus:ring-2 focus:ring-emerald-500 resize-none h-9 align-middle text-gray-900 dark:text-zinc-100"
                />
      ...
      {showUploadSimModal && (
        <div className="absolute inset-0 bg-black/40 backdrop-blur-[2px] flex items-center justify-center p-4 z-40">
