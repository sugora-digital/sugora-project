...
import { AppWindow, Heart, MessageSquare, Bookmark, Share2, Youtube, ExternalLink, ArrowLeft, RefreshCw, Send, ShieldCheck, Sparkles } from 'lucide-react';
    ...
    <div id="apps-webview-wrapper" className="space-y-6">
      {!selectedApp ? (
        ...
        <div className="flex flex-col h-[640px] bg-white dark:bg-zinc-950 rounded-2xl overflow-hidden border border-gray-100 dark:border-zinc-800/60 shadow-xl">
          ...
          <div className="flex-1 relative bg-gray-50 p-2 overflow-y-auto">
            {isLoadingFrame && (
              <div className="absolute inset-0 bg-white/70 dark:bg-zinc-900/80 backdrop-blur-xs flex flex-col items-center justify-center z-13">
