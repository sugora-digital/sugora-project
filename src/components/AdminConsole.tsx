...
import { Settings, Users, ShieldAlert, FileText, ShoppingCart, DollarSign, Plus, Check, X, Edit3, Lock, Trash2, Award } from 'lucide-react';
...
export default function AdminConsole({
  ...
  return (
    <div id="admin-management-wrap" className="space-y-6">
          ...
          {(['stats', 'users', 'kyc', 'shop', 'settings'] as const).map(tab => (
            <button
              ...
              className={`rounded-lg px-3 py-1.5 text-xs font-semibold capitalize transition ${
                activeTab === tab
                  ? 'bg-white text-emerald-700 shadow-xs dark:bg-zinc-800 dark:text-zinc-100'
      ...
      {activeTab === 'users' && (
        <div className="bg-white dark:bg-zinc-900 border rounded-2xl p-5 shadow-xs">
                  ...
                  <tr key={u.id}>
                    ...
                    <td className="p-3">
                      <span className={`rounded-full px-2 py-0.5 text-[9px] font-bold ${
                        u.is_verified ? 'bg-emerald-50 text-emerald-800' : 'bg-gray-100 text-gray-400'
                      }`}>
        ...
        <div className="bg-white dark:bg-zinc-900 border rounded-2xl p-5 shadow-xs">
          ...
          {kycRequests.length === 0 ? (
            ...
            <div className="space-y-4">
              {kycRequests.map(req => (
                <div key={req.id} className="p-4 bg-gray-50 dark:bg-zinc-950 border rounded-xl flex flex-col md:flex-row md:items-center justify-between gap-4">
                  <div className="space-y-1">
                    ...
                    <div className="text-[11px] text-gray-500 grid grid-cols-2 gap-x-4 gap-y-1 max-w-sm font-mono">
                  ...
                  {req.status === 'pending' && (
                    <div className="flex gap-2">
                      <button
                        ...
                        className="rounded-xl border border-rose-200 text-rose-700 bg-white hover:bg-rose-50 px-3 py-2 text-xs font-bold transition flex items-center gap-1"
                      >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white dark:bg-zinc-900 border rounded-2xl p-5 shadow-xs">
            <h3 className="text-sm font-bold text-gray-900 dark:text-zinc-100 flex items-center gap-1 mb-4">
              <Plus className="h-4.5 w-4.5" /> Append Marketplace Product
            </h3>
            ...
            <form onSubmit={handleCreateProduct} className="space-y-4 text-xs font-medium">
              <div>
                ...
                <input
                  ...
                  className="w-full rounded bg-gray-50 dark:bg-zinc-950 p-2 text-xs border"
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full rounded bg-gray-50 dark:bg-zinc-950 p-2 text-xs border h-20 resize-none"
                />
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full rounded bg-white dark:bg-zinc-950 p-2 border"
                  >
          ...
          <div className="bg-white dark:bg-zinc-900 border rounded-2xl p-5 shadow-xs">
            ...
            <div className="space-y-3.5 max-h-[460px] overflow-y-auto">
              {products.map(p => (
                <div key={p.id} className="flex gap-3 items-center border-b pb-3 border-gray-50 dark:border-zinc-800">
                  <img referrerPolicy="no-referrer" src={p.image_url} alt={p.name} className="h-10 w-10 object-cover rounded bg-zinc-100" />
                  <div className="flex-1 min-w-0">
                    <span className="block font-bold text-xs truncate text-gray-900 dark:text-zinc-100">{p.name}</span>
      ...
      {activeTab === 'settings' && (
        <div className="bg-white dark:bg-zinc-900 border rounded-2xl p-5 shadow-xs max-w-md">
          ...
          <div className="space-y-4">
            <div>
              ...
              <div className="flex gap-2">
                <input
                  ...
                  className="rounded-xl bg-gray-50 dark:bg-zinc-950 px-3 py-2 border w-24 text-xs font-mono font-bold"
                />
                <button
            ...
            <div className="text-[11px] text-gray-500 leading-relaxed bg-amber-50/50 p-3.5 rounded-xl border">
