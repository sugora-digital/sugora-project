...
import { Wallet, Landmark, QrCode, CreditCard, ChevronRight, CheckCircle, ShieldAlert, AlertCircle, FileText, Camera, IndianRupee } from 'lucide-react';
import { Profile, Wallet as WalletType, WalletTransaction, KYCRequest } from '../types';
...
export default function WalletKYC({
  ...
  return (
    <div id="wallet-kyc-main-root" className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="bg-white dark:bg-zinc-900 border border-gray-100 dark:border-zinc-800 rounded-2xl p-5 shadow-sm">
          ...
          {kycStatus === 'unsubmitted' && (
            <form onSubmit={handleKYCFormSubmit} className="space-y-4">
              ...
              <div className="bg-gray-50 dark:bg-zinc-950 p-4 rounded-xl border border-dashed flex justify-around gap-2 text-xs text-gray-400">
          ...
          {kycStatus === 'pending' && (
            <div className="p-8 text-center bg-blue-50/50 dark:bg-blue-950/20 rounded-2xl border border-blue-200/50">
              ...
              <div className="mt-4 p-2.5 bg-blue-100/50 dark:bg-blue-950/45 rounded-xl border text-[10px] text-blue-800 dark:text-blue-300">
          ...
          {kycStatus === 'rejected' && (
            <div className="p-8 text-center bg-rose-50/50 dark:bg-rose-950/20 rounded-2xl border border-rose-200/50">
              ...
              <button
                onClick={() => onSubmitKYC('', '', '', '', '')} // resets state internally in parent
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full rounded-xl bg-gray-50 dark:bg-zinc-950 pl-7 pr-3 py-2.5 text-xs text-gray-900 dark:text-zinc-100 border text-medium"
                  />
                </div>
              </div>
      ...
      {showWithdrawModal && (
        <div className="fixed inset-0 bg-black/40 backdrop-blur-xs flex items-center justify-center p-4 z-50">
          <div className="w-full max-w-sm rounded-2xl bg-white p-5 shadow-2xl dark:bg-zinc-900 border dark:border-zinc-800/80">
            ...
            {kycStatus !== 'approved' ? (
              <div className="p-3 bg-amber-50 rounded-xl border text-xs text-amber-800 flex gap-2 mt-4">
